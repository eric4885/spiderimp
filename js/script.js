...
var menuDifficulty = '2';

function getDifficultyFromUrl() {
	var m = /[?&]suits=([124])(?:&|$)/.exec(window.location.search);
	if (m) {
		return m[1];
	}
	return null;
...
setMenuDifficulty(getDifficultyFromUrl() || '2');
